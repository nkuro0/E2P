...
if(empty($errors)){
    ...
    $sql = "UPDATE users SET firstname = ?, `name` = ?, username = ?, password = ?, mail = ?, levelUser = ? WHERE id = '$id'";
    $req = $dbh->prepare($sql);
    ...
    die('<div class="ui container center aligned segment">
            <h2 class="ui header center aligned">La modification s\'est bien déroulée</h2>
