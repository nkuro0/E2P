    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <?=$_SESSION['auth']->name?>&nbsp<?= $_SESSION['auth']->firstname ?> <b class="caret"></b></a>
                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        ...
                        <ul id="demo" class="collapse">
                            <?php
                            $sql ="SELECT id, link FROM pages ORDER BY link ASC";
                            $result = $dbh->query($sql);
                            echo '<li><a href="?page=insertPage">Ajouter une page</a></li>';
                            while ($row = $result->fetchObject()) {
                                echo '<li><a href="?page=pages&amp;id='.$row->id.'">'.$row->link.'</a></li>';
                            }
                            ?>
                        </ul>
                    </li>
                    <li>
                        <a href="?page=news"><i class="fa fa-fw fa-file"></i> Gestion des news</a>
                    </li>
                    <li>
