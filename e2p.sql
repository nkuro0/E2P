...
--
-- Client :  127.0.0.1
-- Généré le :  Lun 20 Février 2017 à 18:24
...
(4, 'Dishonored 2', '24.40', '2016-11-11', 3, 'dishonored2Min.jpg', 0, 15, 'Endossez à nouveau le rôle d\'assassin surnaturel dans Dishonored 2, le nouveau chapitre tant attendu de Dishonored, la saga maintes fois récompensée signée Arkane Studios. Explorez à votre manière un monde où mysticisme et industrialisation cohabitent. Choisirez-vous d\'incarner l\'Impératrice Emily Kaldwin, ou le Protecteur royal Corvo Attano ? Traverserez-vous le jeu comme une ombre insaisissable, ferez-vous un usage immodéré du redoutable système de combat, ou un peu des deux ? Comment allez-vous combiner les pouvoirs uniques, les armes et les gadgets de votre personnage pour éliminer vos ennemis ? Au fil des missions élaborées de main de maître, vos choix réécriront l\'histoire et mèneront à des dénouements inattendus.', 1),
...
(1, 'ESCW world cup', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer fringilla finibus ante. Curabitur justo erat, maximus at faucibus sit amet, faucibus eget orci. Fusce nunc libero, auctor eu euismod quis, pulvinar ut est. Praesent dapibus at felis a vulputate. Proin varius sapien eget metus vulputate, eget fermentum risus convallis. Aliquam consectetur volutpat est, sit amet mattis metus finibus at. Vestibulum eget justo eu leo hendrerit auctor.', '2017-01-04', '10:32:15', 'ESWC2016.png', 1),
